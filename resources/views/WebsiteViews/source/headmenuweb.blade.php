<style>
#headmenu{
    background-image: linear-gradient(to bottom, rgba(13, 110, 253, 0.25), #86b7fe);

}

#block-category .list_menu {
  display: none;
...
#block-category:hover .list_menu {
  display: block;
  transition: 0.3s;
}
.item_big {
...
#block-category {
  background-color: #f1f1f1; /* Màu nền cho mục "Danh mục sản phẩm" */
}

#block-category .title-menu {
  color: #333; /* Màu chữ cho mục "Danh mục sản phẩm" */
}

#block-category .list_menu {
  background-color: #fff; /* Màu nền cho dropdown menu */
}

#block-category .list_menu a {
  color: #333; /* Màu chữ cho các mục trong dropdown menu */
}

#block-category .list_menu a:hover {
  background-color: #f1f1f1; /* Màu nền khi hover vào các mục trong dropdown menu */
}
.item_big {
  display: flex;
  flex-wrap: wrap;
  justify-content: space-between; /* Căn chỉnh các mục trong item_big theo chiều ngang */
}

.item_big li {
  flex-basis: calc(20% - 10px); /* Định nghĩa chiều rộng của mỗi mục */
...
<div class="header-menu">
    <div class="container" style="display:flex">
        <div class="row" id="block-menunavs">
            <div class="col" id="block-category">
                        ...
                        <div class="list_menu">
                            ...
                            <div class="nd-header-search nd-searchs d-md-none d-block">
                                ...
                                <div class="results-box" style="display: none;"><div class="search-results"></div></div></div>
                                <ul class="item_big" style="display:flex;flex:wrap">


                                    <li class="nav-item ">
                                        <a class="a-img caret-down" href="/vpp-hoc-sinh" title="VPP Học Sinh">
                                            VPP Học Sinh
                                        </a>
                                        ...
                                        <ul class="item_small">
                                            ...
                                            <li>
                                                <a class="" href="/boc-vo" title="Bọc vở">
                                                    Bọc vở
                                                </a>
                                            ...
                                            <li>
                                                <a class="" href="/nhan-vo" title="Nhãn vở">
                                                    Nhãn vở
                                                </a>
                                    ...
                                    <li class="nav-item ">
                                        <a class="a-img caret-down" href="/vpp-van-phong" title="VPP Văn phòng">
                                            VPP Văn phòng
                                        </a>
                                        <i class="fa fa-caret-down"></i>
                                        <ul class="item_small">
                                            ...
                                            <li>
                                                <a class="" href="/kep-tai-lieu" title="Kẹp tài liệu">
                                                    Kẹp tài liệu
                                                </a>
                                            ...
                                            <li>
                                                <a class="" href="/so-tai-lieu" title="Sổ tài liệu">
                                                    Sổ tài liệu
                                                </a>
                                            ...
                                            <li>
                                                <a class="" href="/ban-ghim" title="Bắn ghim">
                                                    Bắn ghim
                                                </a>
                                            ...
                                            <li>
                                                <a class="" href="/giay-note" title="Giấy note">
                                                    Giấy note
                                                </a>
                                            ...
                                            <li>
                                                <a class="" href="/giay-in" title="Giấy in">
                                                    Giấy in
                                                </a>
                                            ...
                                            <li>
                                                <a class="" href="/trang-tri-van-phong" title="Trang trí văn phòng">
                                                    Trang trí văn phòng
                                                </a>
                                    ...
                                    <li class="nav-item ">
                                        <a class="a-img caret-down" href="/dung-cu-ve" title="Dụng Cụ Vẽ">
                                            Dụng Cụ Vẽ
                                        </a>
                                        <i class="fa fa-caret-down"></i>
                                        <ul class="item_small">
                                            ...
                                            <li>
                                                <a class="" href="/but-ve" title="Bút vẽ">
                                                    Bút vẽ
                                                </a>
                                            ...
                                            <li>
                                                <a class="" href="/mau-ve" title="Màu vẽ">
                                                    Màu vẽ
                                                </a>
                                            ...
                                            <li>
                                                <a class="" href="/khay-co-ve" title="Khay - Cọ vẽ">
                                                    Khay - Cọ vẽ
                                                </a>
                                            ...
                                            <li>
                                                <a class="" href="/tap-ve-giay-ve" title="Tập vẽ - Giấy vẽ">
                                                    Tập vẽ - Giấy vẽ
                                                </a>
                                            ...
                                            <li>
                                                <a class="" href="/bo-ve-sang-tao" title="Bộ vẽ sáng tạo">
                                                    Bộ vẽ sáng tạo
                                                </a>
                                            ...
                                            <li>
                                                <a class="" href="/gia-ve-khung-ve" title="Giá vẽ - Khung vẽ">
                                                    Giá vẽ - Khung vẽ
                                                </a>
                                    ...
                                    <li class="nav-item ">
                                        <a class="a-img caret-down" href="/but-viet" title="Bút viết">
                                            Bút viết
                                        </a>
                                        <i class="fa fa-caret-down"></i>
                                        <ul class="item_small">
                                            ...
                                            <li>
                                                <a class="" href="/but-chi" title="Bút chì">
                                                    Bút chì
                                                </a>
                                            ...
                                            <li>
                                                <a class="" href="/but-nuoc" title="Bút nước">
                                                    Bút nước
                                                </a>
                                            ...
                                            <li>
                                                <a class="" href="/but-long" title="Bút lông">
                                                    Bút lông
                                                </a>
                                            ...
                                            <li>
                                                <a class="" href="/but-da-quang" title="Bút dạ quang">
                                                    Bút dạ quang
                                                </a>
                                            ...
                                            <li>
                                                <a class="" href="/but-muc" title="Bút mực">
                                                    Bút mực
                                                </a>
                                    ...
                                    <li class="nav-item ">
                                        <a class="a-img caret-down" href="/san-pham-ve-giay" title="Sản phẩm về giấy">
                                            Sản phẩm về giấy
                                        </a>
                                        <i class="fa fa-caret-down"></i>
                                        <ul class="item_small">
                                            ...
                                            <li>
                                                <a class="" href="/so-cac-loai" title="Sổ các loại">
                                                    Sổ các loại
                                                </a>
                                            ...
                                            <li>
                                                <a class="" href="/tap-vo" title="Tập - Vở">
                                                    Tập - Vở
                                                </a>
                                            ...
                                            <li>
                                                <a class="" href="/giay-note-1" title="Giấy note">
                                                    Giấy note
                                                </a>
                                            ...
                                            <li>
                                                <a class="" href="/sticker" title="Sticker">
                                                    Sticker
                                                </a>
                                            ...
                                            <li>
                                                <a class="" href="/cac-loai-giay-khac" title="Các loại giấy khác">
                                                    Các loại giấy khác
                                                </a>
                                            ...
                                            <li>
                                                <a class="" href="/nhan-vo-nhan-ten" title="Nhãn vở - Nhãn tên">
                                                    Nhãn vở - Nhãn tên
                                                </a>
            ...
            <div class="col">
                ...
                <div class="block-slogan">
                    <span style="display: inline; opacity: 0.784281;">Stationery lựa chọn số 1 cho bạn</span>
                </div>
